...
export const Searchbar = () => {
  ...
  const { data }: { data: searchResults[] } = useSWR(searchTerm ? `https://www.metricgamer.com/api/search/?search=${searchTerm}` : null, fetcher);
  ...
  return (
    <>
      <div className='searchbar-container'>
        ...
        <input onChange={handleInputChange} className={"searchbar"} type="text" placeholder="search" />
