import { emptyPost, renderedHeadings, testPost, mockEmptyElement, mockTitleWithRating } from '@/types/testTypes';
...
describe('replaceComponents', () => {
  ...
  describe('replaceWithTitleWithRating', () => {
    ...
    it('When given Element that consists of a text with number parse to react component', () => {
      const result = {
        ...mockEmptyElement, name: "h2",
        children: [
          {
